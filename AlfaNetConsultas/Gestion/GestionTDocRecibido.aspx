...
<%@ Register Assembly="DevExpress.Web.v9.1, Version=9.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" 
        Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp1" %>
<%@ Register Assembly="DevExpress.Web.v9.1, Version=9.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" 
        Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dxp" %>
<%--<%@ Register Assembly="DevExpress.Web.ASPxEditors.v9.1, Version=9.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" 
        Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>--%>
                    ...
                    <cc1:Accordion ID="MyAccordion" runat="server" Width="100%" TransitionDuration="250"
                        ...
                        <Panes>
                            <cc1:AccordionPane ID="AccordionPane1" Font-Size="medium" runat="server" ContentCssClass="" HeaderCssClass="">
                                <Header>
                                    <a class="accordionLink" href="">Consulta Gestion de Tareas.:
                                    </a>
                                </Header>
                                <Content>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 8px" colspan="3">&nbsp;
                                                    <asp:DropDownList id="DDLSel" runat="server" Width="500px" CausesValidation="True" ValidationGroup="Buscar">
                                                        ...
                                                        <asp:ListItem Value="1">Documentos en Tramite Terminado (Archivado)</asp:ListItem>
                                                        <asp:ListItem Value="2">Documentos sin Terminar Tramite (No Archivado)</asp:ListItem>
                                                        <asp:ListItem Value="3">Documentos Archivados y Sin Archivar</asp:ListItem>
                                                    </asp:DropDownList>&nbsp;
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ValidationGroup="Buscar" 
                                                            ControlToValidate="DDLSel" 
                                                            ErrorMessage="Debe Seleccionar un tipo de Documento" InitialValue="0" SetFocusOnError="True">
                                                    </asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 8px" colspan="3">&nbsp;
                                                    <asp:DropDownList id="DDLRespuesta" runat="server" Width="500px" CausesValidation="True" ValidationGroup="Buscar">
                                                        <asp:ListItem Value="0">Seleccione...</asp:ListItem>
                                                        <asp:ListItem Value="1">Documentos Con Respuesta</asp:ListItem>
                                                        <asp:ListItem Value="2">Documentos Sin Respuesta</asp:ListItem>
                                                        <asp:ListItem Value="">Documentos Con Respuesta y Sin Respuesta</asp:ListItem>
                                                    </asp:DropDownList>&nbsp;
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ValidationGroup="Buscar" 
                                                            ControlToValidate="DDLRespuesta" 
                                                            ErrorMessage="Debe Seleccionar un tipo de respuesta" InitialValue="0" SetFocusOnError="True">
                                                    </asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 8px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelFechas" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <cc1:CalendarExtender id="CalendarFinal" runat="server" TargetControlID="TxtFechaFinal" Format="dd/MM/yyyy" 
                                                                    PopupButtonID="ImgCalendarFinal">
                                                            </cc1:CalendarExtender>
                                                            <cc1:CalendarExtender id="CalendarInicial" runat="server" TargetControlID="TxtFechaInicial" Format="dd/MM/yyyy" 
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label id="LblFechaFinal" runat="server" Width="55px" Visible="False">FechaFinal
                                                                            </asp:Label>
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ChBFechaRad" EventName="CheckedChanged">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label id="LblFechaFinFinal" runat="server" Width="55px" Visible="False">FechaFinal
                                                                            </asp:Label>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label id="LblFechaVenFinal" runat="server" Width="55px" Visible="False">FechaFinal
                                                                            </asp:Label>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; BACKGROUND-COLOR: #ffffff">
                                                    <asp:UpdatePanel id="UpdatePanelDestino" runat="server" UpdateMode="Conditional">
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ChBDependencias" EventName="CheckedChanged">
                                                            </asp:AsyncPostBackTrigger>
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </td>
                                                ...
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UPProceso" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:Panel id="Panel88" runat="server" Width="300px" Height="300px" CssClass="popupControl" ScrollBars="Vertical">
                                                                <div>
                                                            ...
                                                            <asp:TextBox id="TxtBProceso" runat="server" Width="400px" Font-Size="8pt" Visible="False" 
                                                                    CssClass="TxtAutoComplete">
                                                            </asp:TextBox> 
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                ...
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UPAccion" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:RequiredFieldValidator id="RFVAccion" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBAccion" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <cc1:AutoCompleteExtender id="AutoCompleteAccion" runat="server" TargetControlID="TxtBAccion" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetWFAccionTextByText" 
                                                                    MinimumPrefixLength="1" CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                            <cc1:PopupControlExtender id="PopupControlAccion" runat="server" TargetControlID="TxtBAccion" 
                                                                    PopupControlID="PnlAccion" Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <asp:Panel id="PnlAccion" runat="server" Width="300px" Height="300px" CssClass="popupControl" 
                                                                    ScrollBars="Vertical">
                                                                <div>
                                                                    <asp:TreeView id="TreeVAccion" runat="server" Width="300px" ShowLines="True" 
                                                                        ...
                                                                        <Nodes>
                                                                            <asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction="Expand" 
                                                                                    Text="Seleccione Accion..." Value="0">
                                                                            </asp:TreeNode>
                                                                        </Nodes>
                                                            ...
                                                            <asp:TextBox id="TxtBAccion" runat="server" Width="400px" Font-Size="8pt" Visible="False" 
                                                                    CssClass="TxtAutoComplete">
                                                            </asp:TextBox> 
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelNaturaleza" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBNaturaleza" runat="server" Width="185px" Text="Por Naturaleza" 
                                                                    AutoPostBack="True" OnCheckedChanged="ChBNaturaleza_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            ...
                                                            <cc1:AutoCompleteExtender id="AutoCompleteNaturaleza" runat="server" TargetControlID="TxtBNaturaleza" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetNaturalezaByText" 
                                                                    MinimumPrefixLength="1" CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                ...
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelExpediente" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:TextBox id="TxtBExpediente" runat="server" Width="400px" Font-Size="8pt" Visible="False" 
                                                                    CssClass="TxtAutoComplete">
                                                            </asp:TextBox>
                                                            <asp:Panel id="PnlExpediente" runat="server" Height="300px" CssClass="popupControl" ScrollBars="Vertical">
                                                                <div>
                                                                    <asp:TreeView id="TreeVExpediente" runat="server" Width="300px" ShowLines="True" 
                                                                            ...
                                                                            OnSelectedNodeChanged="TreeVExpediente_SelectedNodeChanged" ExpandDepth="0" ImageSet="Simple">
                                                                        <ParentNodeStyle Font-Bold="False">
                                                                        </ParentNodeStyle>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelProcedencia" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBProcedencia" runat="server" Width="185px" Text="Por Procedencia" 
                                                            ...
                                                            <asp:TextBox id="TxtBProcedencia" runat="server" Width="400px" Font-Size="8pt" Visible="False" 
                                                                    CssClass="TxtAutoComplete">
                                                            </asp:TextBox> 
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="style1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="WIDTH: 65px">
                                                                    <dxe:ASPxButton id="ButtonSaveAs" onclick="ButtonSaveAs_Click" runat="server" 
                                                                            Text="Guardar" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue">
                                                                    </dxe:ASPxButton>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <dxpc:ASPxPopupControl id="popup" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" 
                                                            CssPostfix="Office2003_Blue" ImageFolder="~/App_Themes/Office2003 Blue/{0}/" 
                                                            ClientInstanceName="popup" AllowDragging="True" PopupHorizontalAlign="OutsideRight" HeaderText="Vinculo a Respuesta">
                                                        <ClientSideEvents Shown="popup_Shown">
                                                        </ClientSideEvents>
                                                        <ContentCollection>
                                                            <dxpc:PopupControlContentControl runat="server">
                                                                <dxcp1:ASPxCallbackPanel runat="server" ClientInstanceName="callbackPanel" RenderMode="Table" 
                                                        ...
                                                        <ContentTemplate>
                                                            <dxwgv:ASPxGridView id="ASPxGridView1" runat="server" Width="100%" 
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="Registro" Caption="Registro" VisibleIndex="10">
                                                                        <Settings AutoFilterCondition="Contains">
                                                                        </Settings>
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="FechaRegistro" Caption="FechaRegistro" VisibleIndex="10">
                                                                        <Settings AutoFilterCondition="Contains">
                                                                        </Settings>
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="Opciones" UnboundType="String" Caption="Opciones" VisibleIndex="11">
                                                                        ...
                                                                        <DataItemTemplate>
                                                                            ...
                                                                            <asp:HyperLink id="HprLnkHisExtven" runat="server" Width="55px" Font-Underline="True" 
                                                                                    CssClass="LinKBtnStyleBig">Histórico
                                                                            </asp:HyperLink>
                                                                            <br />
