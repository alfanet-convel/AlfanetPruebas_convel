...
public class WorkFlowBLL
{
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos vencidos (metodo2)*/
    public int GetDocVenv1Rowsv2(Int32 WFMovimientoTipo1, Int32 WFMovimientoTipo2, String DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha)
    {
        int _res = 0;
        WFMovimientoTableAdapter _t1 = new WFMovimientoTableAdapter();
        DSWorkFlow.WFMovimientoDataTable _t2 = new DSWorkFlow.WFMovimientoDataTable();
        try
        {
            _t2 = _t1.GetDocVenv3DataBy(WFMovimientoTipo1, WFMovimientoTipo2, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[19].ToString());
            }
            else
            {
                _res = 0;
    ...
    #region documentos próximos a vencer
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos proximos a vencer (metodo2)*/
    public int GetDocProxVenv1Rowsv2(Int32 WFMovimientoTipo, Int32 WFMovimientoTipo2, String DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha)
    {
        int _res = 0;
        WFMovimientoTableAdapter _t1 = new WFMovimientoTableAdapter();
        DSWorkFlow.WFMovimientoDataTable _t2 = new DSWorkFlow.WFMovimientoDataTable();
        try
        {
            _t2 = _t1.GetDocProxVenv3By(WFMovimientoTipo, WFMovimientoTipo2, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[19].ToString());
            }
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos pendientes(metodo 2)*/
    public int GetDocPendv1Rowsv2(Int32 WFMovimientoTipo, Int32 WFMovimientoTipo2, String DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha)
    {
        int _res = 0;
        WFMovimientoTableAdapter _t1 = new WFMovimientoTableAdapter();
        DSWorkFlow.WFMovimientoDataTable _t2 = new DSWorkFlow.WFMovimientoDataTable();
        try
        {
            _t2 = _t1.GetDocPenv3By(WFMovimientoTipo, WFMovimientoTipo2, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[19].ToString());
            }
    ...
    #region documentos copia recibidos
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos  copia recibidos(metodo2)*/
    public int GetDocCopiav1Rowsv2(Int32 WFMovimientoTipo, Int32 WFMovimientoTipo2, String DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha)
    {
        int _res = 0;
        WFMovimientoTableAdapter _t1 = new WFMovimientoTableAdapter();
        DSWorkFlow.WFMovimientoDataTable _t2 = new DSWorkFlow.WFMovimientoDataTable();
        try
        {
            _t2 = _t1.GetDocCopiav3By(WFMovimientoTipo, WFMovimientoTipo2, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[17].ToString());
            }
            else
            {
                _res = 0;
    ...
    #region documentos copia enviados
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos  copia enviados*/
    public int GetDocCopiaEnviadosv1Rowsv2(Int32 WFMovimientoTipo, Int32 WFMovimientoTipo2, String DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha)
    {
        int _res = 0;
        WFMovimiento_ReadWFMovimientoCopiaEnviadoTableAdapter _t1 = new WFMovimiento_ReadWFMovimientoCopiaEnviadoTableAdapter();
        DSWorkFlow.WFMovimiento_ReadWFMovimientoCopiaEnviadoDataTable _t2 = new DSWorkFlow.WFMovimiento_ReadWFMovimientoCopiaEnviadoDataTable();
        try
        {
            _t2 = _t1.GetDocCopiaEnviadav3By(WFMovimientoTipo, WFMovimientoTipo2, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[15].ToString());
            }
            else
            {
                _res = 0;
    ...
    /*metodo para devolver la cantidad de resultados obtenidos de documentos  enviados(metodod2)*/
    public int GetDocEnviadosv1Rowsv2(int WFMovimientoTipo, string DependenciaCodDestino, String GrupoCodigo, DateTime WFMovimientoFecha, Int32 WFControlDias)
    {
        int _res = 0;
        WFMovimiento_ReadWFMovimientoCopiaEnviadoTableAdapter _t1 = new WFMovimiento_ReadWFMovimientoCopiaEnviadoTableAdapter();
        DSWorkFlow.WFMovimiento_ReadWFMovimientoCopiaEnviadoDataTable _t2 = new DSWorkFlow.WFMovimiento_ReadWFMovimientoCopiaEnviadoDataTable();
        try
        {
            _t2 = _t1.GetDocEnviadov3By(WFMovimientoTipo, DependenciaCodDestino, GrupoCodigo, WFMovimientoFecha, WFControlDias, 10, 0);
            if (_t2.Rows.Count > 0)
            {
                _res = int.Parse(_t2.Rows[0].ItemArray[16].ToString());
            }
            else
            {
                _res = 0;
