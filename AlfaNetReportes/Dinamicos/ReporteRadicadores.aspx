                    ...
                    <tr>
                        ...
                        <td style="width: 100px; height: 36px;">
                            <telerik:RadDatePicker ID="RadDatePicker1" runat="server" Skin="Outlook">
                                ...
                                <DateInput DateFormat="yyyy.MM.dd" DisplayDateFormat="dd/MM/yyyy">
                                </DateInput>
...
<ProgressBar Height="25px"></ProgressBar>
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="RadDatePicker1" DbType="DateTime" DefaultValue="1800.01.01"
                            Name="FechaInicial" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="RadDatePicker2" DbType="DateTime" DefaultValue="2020.01.01"
