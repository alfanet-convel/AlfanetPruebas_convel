...
<dxwpg:PivotGridField FieldName="WFMovimientoFecha" ID="PivotGridField1" 
        ...
        UnboundFieldName="fieldRadicadoFecha" Caption="F. Radicacion"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="DependenciaNombre" ID="fieldActualmenteEn" 
        ...
        Caption="Dep Actual"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="NaturalezaNombre" ID="fieldRadicadoNaturaleza" 
        ...
        Caption="Naturaleza"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="RadicadoCodigo" ID="fieldRadicadoNumero" 
        Area="RowArea" AreaIndex="0" Caption="Radicado" SummaryType="Count"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="RadicadoFechaVencimiento" 
        ...
        UnboundFieldName="fieldRadicadoFechaVencimiento" Caption="F. Vencimiento"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="WFMovimientoPasoFinal" ID="fieldRadicadoMaxPaso" 
        ...
        UnboundFieldName="fieldRadicadoMaxPaso" Caption="Paso Final"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="ProcedenciaNombre" ID="fieldRadicadoProcedencia" 
        ...
        Caption="Procedencia"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="RadicadoDetalle" ID="fieldRadicadoDetalle" 
        ...
        Caption="Detalle"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="SerieNombre" ID="fieldRespuestaTipo" 
        GroupIndex="0" InnerGroupIndex="7" Area="RowArea" AreaIndex="8" Caption="Serie"></dxwpg:PivotGridField>
<dxwpg:PivotGridField FieldName="Respuesta" ID="fieldRespuestaNumero" 
        Area="RowArea" AreaIndex="11" Caption="Respuesta"></dxwpg:PivotGridField>
...
<dxwpg:PivotGridField FieldName="DiasVencimiento" ID="fieldRespuestaDV" 
        Area="RowArea" AreaIndex="9" Caption="DV." GroupIndex="0" InnerGroupIndex="8"></dxwpg:PivotGridField>
</Fields>
...
</dxwpg:ASPxPivotGrid><asp:SqlDataSource id="AlfaWeb" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStrSQLServer %>" SelectCommand="Radicado_ReadRadicadoInformeGestion" SelectCommandType="StoredProcedure" onselecting="AlfaWeb_Selecting"><SelectParameters>
