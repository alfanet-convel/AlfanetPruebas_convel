...
//         return false;          
           ...
           function urlRpta(evt,NumeroDocumento)
        {
         var src = window.event != window.undefined ? window.event.srcElement : evt.target;
            //aardila - Inicio
               ...
               hidden = open('../../AlfaNetPlantillas/Page_VisorPlantillas.aspx?RadicadoCodigo=' + NumeroDocumento + '&Admon=S&RptaImg=S', 'NewWindow','top=0,left=0, width=800,height=600,status=yes, resizable=yes, menubar=yes,scrollbars=yes');
            //aardila - Fin
        }
        ...
        function urlRptaPlantilla(evt)
        {
         var src = window.event != window.undefined ? window.event.srcElement : evt.target;
            //aardila - Inicio
               //hidden = open('../../AlfaNetDocumentos/DocEnviado/NuevoDocEnviadoInt.aspx?RadicadoCodigo=' + NumeroDocumento + '&Admon=S&RptaImg=S', 'NewWindow','top=0,left=0, width=800,height=600,status=yes, resizable=yes,scrollbars=yes');
               hidden = open('../../AlfaNetPlantillas/Page_VisorPlantillas.aspx', 'NewWindow','top=0,left=0, width=800,height=600,status=yes, resizable=yes, menubar=yes,scrollbars=yes');
            //aardila - Fin
        }
